...
try:
    ...
    print("Warning: pyemd not available. EMD-based metrics will use approximation.")
...
def emd(x, y, distance_scaling=1.0):
    ...
    if PYEMD_AVAILABLE:
        ...
        # Fallback: use Wasserstein distance approximation (L1 distance)
        emd_value = np.sum(np.abs(x - y))
