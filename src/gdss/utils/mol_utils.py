...
def gen_mol(x, adj, dataset, largest_connected_comp=True):
    ...
    # Returns: (mols, num_no_correct, orig_indices)
    # `orig_indices` is a list of indices in the input batch corresponding to
    # the returned `mols` (useful after filtering invalid molecules).
    ...
    return mols, num_no_correct, orig_indices
